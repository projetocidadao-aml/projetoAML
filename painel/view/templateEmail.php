 				...
 				<table align='center' border='0' cellpadding='0' cellspacing='0' style='width:500px'>
 					<tbody>
 						<tr>
 							...
 							<td><img src='https://fatweb.s3.amazonaws.com/vestibulinhoetec/img/layout/logotipo-etec.png' border='0' alt='' style='display:block;' width='120px;'></td>
 					...
 					<tbody>
 						...
 						<tr>
 							<td style='background-color:#fff;text-align:left; padding-left: 15px; padding-right: 5px;'>
 								<h2 style='font-weight: normal; color: #5F259F; text-align: center; margin-top: 0; margin-bottom: 10px;'>Etec: <b><u><?php echo $etec?></u></b></h2>
 								...
 								<span style='
 								color: #333; font-size: 17px; font-family:Arial'><b>Login do Portal:</b> <?php echo $user?></span> 
 								<br>
 								<br>
 								<span style='
 								color: #333; font-size: 17px; font-family:Arial'><b>Senha do Portal:</b> <?php echo $password?></span> 
 								<br>
