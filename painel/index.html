...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark mb-4">
		<div class="container">
			<a class="navbar-brand" href="#">Cidadão do Futuro</a>
		</div>
	</nav>
	<!--Header  -->
	...
	<div class="container">
		...
		<div class="row">
				...
				<div class="row m-auto">
					<div class="col-12 px-5 py-2 border">
						...
						<div class="text-center">
							...
							<a href="EcadastroEtec.html" class="d-block mb-3">Cadastre-se</a>
			...
			<div class="col-6" id="imgIndex">
				<img src="img/logo.png" class="img-thumbnail img-responsive border-0">
			</div>
